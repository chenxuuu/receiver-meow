...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Id", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "com.papapoi.ReceiverMeow" });	
			...
			type.GetProperty ("Version", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { new Version ("2.1.0") });	
			type.GetProperty ("VersionId", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { 17 });	
		...
		{	
			return "9,com.papapoi.ReceiverMeow";	
		}	
		...
		{	
			...
			Common.AppInfo.UnityContainer.RegisterInstance<CQApi> ("com.papapoi.ReceiverMeow", api);	
			// 向容器注册一个 CQLog 实例	
			log = new CQLog (authCode);	
			Common.AppInfo.UnityContainer.RegisterInstance<CQLog> ("com.papapoi.ReceiverMeow", log);	
