...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Version", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { new Version ("1.1.0") });	
		...
		{	
			...
			Common.AppInfo.UnityContainer.RegisterInstance<CQLog> ("com.papapoi.ReceiverMeow", logger);	
