    ...
    class TcpServer
    {
        ...
        public static void Start()
        {
            try
            {
                ...
                server.Start(23333);
                Common.AppData.CQLog.Info("tcp server", "tcp server started!");
            ...
            {
                Common.AppData.CQLog.Info("tcp server", "tcp server start failed!\r\n"+e.ToString());
            }
        ...
        public static void Send(string msg)
        {
            ...
            {
                Common.AppData.CQLog.Info("tcp server", "tcp server send failed!\r\n" + e.ToString());
            }
        }
    }
}
